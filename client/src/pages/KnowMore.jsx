    ...
    <div className="bg-gradient-to-br from-[#0F0F0F] to-[#1A1A1A] min-h-screen">
      ...
      <div className="text-white flex flex-col items-center justify-center w-[90%] md:w-[80%] lg:w-[70%] mx-auto py-12 space-y-12">
        <div className="text-center space-y-6 animate-fade-in-up">
          <h1
            className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-[#00A1AB] to-[#00C2CB] bg-clip-text text-transparent"
            data-aos="fade-in"
        ...
        <div className="space-y-16 w-full">
          ...
          <section className="space-y-8">
            ...
            >
              {[
                ...
                <div
                  key={idx}
                  className="p-6 bg-[#ffffff]/5 rounded-xl backdrop-blur-sm border border-[#ffffff]/10 hover:border-[#00A1AB]/50 transition-all duration-300 group"
                >
                  <feature.icon className="h-8 w-8 text-[#00A1AB] mb-4 group-hover:scale-110 transition-transform" />
          ...
          >
            <div className="inline-block bg-gradient-to-r from-[#00A1AB] to-[#00C2CB] p-0.5 rounded-full animate-gradient-x">
              <Link
                to="/authorization"
                className="block px-12 py-3.5 bg-[#0F0F0F] rounded-full text-lg font-semibold hover:bg-transparent transition-colors duration-300"
              >
